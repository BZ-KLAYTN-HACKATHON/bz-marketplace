...
// ID
const ID_SERVICE_ENDPOINT = env.REACT_APP_ID_SERVICE_ENDPOINT
...
// Payment
const PAYMENT_SERVICE_ENDPOINT = env.REACT_APP_PAYMENT_SERVICE_ENDPOINT
const MARKETPLACE_SERVICE_ENDPOINT = env.REACT_APP_MARKETPLACE_SERVICE_ENDPOINT
export const ROFI_PAYMENT = {
  ...
  H2P_BANKCODE: env.REACT_APP_BANKLIST_URL || '',
...
const STORE_BLOCKCHAIN_SERVICE_ENDPOINT =
  env.REACT_APP_STORE_BLOCKCHAIN_SERVICE_ENDPOINT
...
// Token
const TOKEN_SERVICE_ENDPOINT = env.REACT_APP_TOKEN_SERVICE_ENDPOINT
const TOKEN_BLOCKCHAIN_SERVICE_ENDPOINT =
  env.REACT_APP_TOKEN_BLOCKCHAIN_SERVICE_ENDPOINT
...
// NFT
const NFT_SERVICE_ENDPOINT = env.REACT_APP_NFT_SERVICE_ENDPOINT
...
const AIRDROP_BLOCKCHAIN_SERVICE_ENDPOINT =
  env.REACT_APP_AIRDROP_BLOCKCHAIN_SERVICE_ENDPOINT
...
const SYSTEM_CONFIG_SERVICE_ENDPOINT =
  env.REACT_APP_SYSTEM_CONFIG_SERVICE_ENDPOINT
const SYSTEM_CONFIG_APP_ENDPOINT = env.REACT_APP_SYSTEM_CONFIG_APP_ENDPOINT
...
// POOL
const POOL_SERVICE_ENDPOINT = env.REACT_APP_POOL_SERVICE_ENDPOINT
